...
const Body = () => {
  return (
    ...
    <div className='space-y-4 lg:flex-1 lg:order-1 lg:space-y-10'>
      <h1 className='text-4xl font-bold leading-tight font-playfair '>Host your website in less than 5 minutes</h1>
      ...
      <form action="" className='flex flex-col gap-4 md:flex-row'>
        <input className='rounded-md px-4 py-3 placeholder:text-gray-400 bg-white' type="email" placeholder='Enter e-mail address' />
